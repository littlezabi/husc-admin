<script lang="ts">
  ...
  const sort = (by: any): any => {
    ...
    list = departments.sort((a: any, b: any) => {
...
<div class="wrapper-view">
  ...
  <div class="wrapper-inner">
    <div class="head">
      ...
      <div>
        <a class="btn flex" href="/departments/new">
    ...
    <div class="container">
      <table>
        <thead>
          <tr class="item-head item-section">
            <th>#</th>
            <th>
              <div class="flex">
                <Icon src={BuildingLibrary} />
        ...
        <tbody>
          {#each list as item, i}
            ...
            >
              ...
              <td title="click to open url {item.pageUrl}">
                <a href="{item.pageUrl}" target="_blank">
                  {item.pageUrl}
                </a>
              </td>
              <td title={item.faculty}>
                {item.faculty}
              </td>
              ...
              <td>
                <button
                  title="Edit"
                  on:click={() => goto(`/departments/${item._id}`)}
